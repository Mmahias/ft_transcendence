            ...
            <ul className="team" style={{marginTop: '250px'}}>
                <li className="member co-funder">
                    ...
                    <div className="description">
                        ...
                        <RouterLink to='/game'><button className="button-32-f">Invit Game</button></RouterLink>
                        <RouterLink to='/user/history'><button className="button-32-f">Histories</button></RouterLink>
                        <RouterLink to='/chat'><button className="button-32-f">Message</button></RouterLink>
                        <RouterLink to='/user/profile'><button className="button-32-f">Profile</button></RouterLink>
                    </div>
                </li>
                <li className="member co-funder">
                    <div className="thumb"><img src= {userImage} alt="friend_img"/></div>

...
import { verifyPasswords, updateMeInChannel } from "../../api/chat-api";
...
export default function ChannelMore({ channel }: { channel: Channel }) {
	...
	const {data, error, isLoading, isSuccess } = useQuery({queryKey: ['user'], queryFn: getMe});
	...
	}, [data, channel.type, channel.name]);
